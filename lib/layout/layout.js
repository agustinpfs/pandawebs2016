...
$( ".technoh2,.Layout-techno_content" ).css("z-index","5")
$( ".servicesh2,.Layout-services_content" ).css("z-index","0")
...
$( ".technoh2, Layout-techno_content" ).css("z-index","0")
$( ".servicesh2, .Layout-services_content" ).css("z-index","5")
